                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Enregistrer un nouveau Type Visiteur</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('typevisiteur.store')}}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            <label for="libelle">Type visiteurs</label>
                                            <input id="lbelle" type="text" name="libelle"  required="" placeholder="Entrer le type visiteur" class="form-control">
                                        </div>
                                        <div class="row">
