        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('membre.update',$membre->id) }}" class="row g-3" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-md-6 mb-3 form-group">
                            ...
                            <input type="text" name="lieu" required placeholder="Entrer le lieu" class="form-control"  value="{{$membre->lieu}}">
                        </div>
                        <div class="col-md-6 mb-3 form-group">
